...
typedef struct tag_encode_resolution
{
	...
	char codec_name[MAX_NAME_LEN];	//编码格式，当前只有H.264
...
//MSTAR 313e
	...
	PRODUCT_TYPE_MC200P2,			   //313E+PS5280
	PRODUCT_TYPE_MT200E3,             //313E+SC2232+SD+WIFI
	PRODUCT_TYPE_MS200J2,
	PRODUCT_TYPE_MC200E6,        //313E+GC2053
...
//MSTAR 316dm
	...
	PRODUCT_TYPE_MS400L2,			//PRODUCT_TYPE_MC400L2
	PRODUCT_TYPE_MC300L,			//316DM+sc4236
	PRODUCT_TYPE_MC500L,			//316DM+imx335

//MSTAR 328Q
	PRODUCT_TYPE_MC800L = 0xb151, 		//328Q+OS08A10
	...
	PRODUCT_TYPE_MHC31J4,			//PRODUCT_TYPE_MC400L2汉邦定制
	PRODUCT_TYPE_MHC30N2,			//PRODUCT_TYPE_MC200E3汉邦定制
