...
//    AJ_NETSDK_IPC_SetAUXResponseCallBack(GlobalAuxCallBack, this);
//#else
//    IP_NET_DVR_SetStatusEventCallBack(GlobalStatusCallBack, this);
//    IP_NET_DVR_SetAUXResponseCallBack(GlobalAUXCallBack, this);
//#endif
//
//    return ECCS_SUCCESS;
//}
...
//    m_outMode = mode;
//
//    // 如果需要解码 (YUV/RGB)，初始化解码器 (仅 Windows 支持)
...
//        if (m_lPlayerPort > 0) {
//            AJ_PLAYER_SetPlayOn(m_lPlayerPort, 0); // 停止播放
